<div class=" mt-5">
    <footer class="text-center text-lg-start text-white" style="background-color: #292d2d;">
        ...
        <section class="">
            <div class="row justify-content-between">
                    <div class="col-lg-4 col-md-6 mb-4 mb-md-0">
                        ...
                        <p>
                            I nostri valori sono al centro di tutto l'operato di Deliveboo. Ci guidano ogni giorno per lavorare in squadra e prendere decisioni, dalle scelte che hanno un impatto sulle assunzioni e sullo sviluppo del personale, a quelle che scrivono il futuro dei prodotti Deliveboo.
                        </p>
                </div>
                <div class="col-lg-2 col-md-6 mb-4 mb-md-0">
                    ...
                    <ul class="list-unstyled mb-0">
                        ...
                        <li>
                            <a class="nav-link" href="{{ route('register') }}">{{ __('Entra nel team!') }}</a>
                        </li>
                        <li>
        ...
        <section class="mb-4 text-center">
            ...
            <a class="btn btn-outline-light btn-floating m-1" href="https://github.com/" role="button"><i class="fa-brands fa-github"></i></i></a>
        </section>
        </div>
